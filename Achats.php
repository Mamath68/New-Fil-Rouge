...
<table class="table table-responsive table-bordered table-sm">
	...
	<tbody>
		...
		?>
			<tr>
				<!--colonne-->
				<td><?php echo $arrDetArticle['articles_lib']; ?></td>
				<td><?php echo $arrDetArticle['provider_name']; ?></td>
				<td><?php echo "<img src=\"Images/Instruments/" . $arrDetArticle['articles_img'] . "\">";
					$arrDetArticle['articles_img']; ?></td>
				<td><?php echo $arrDetArticle['articles_sellprice']; ?> €</td>
				<td><?php echo $arrDetArticle['articles_stock']; ?></td>
				<td><?php echo $arrDetArticle['articles_cat']; ?></td>
