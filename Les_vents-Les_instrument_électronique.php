...
echo "<title>Instruments à Vent: Les Electroniques</title>";
?>
...
<div class="container">
    ...
    <p>L'octave est choisie parmi sept en positionnant le pouce gauche sur un ensemble de rouleaux. Le capteur de pression d'air permet une grande
    ...
    <br>
    <p>Le dernier modèle en date, produit par akai <a href="https://www.akaipro.com/products/ewi-series">(Pour plus
            d'informations sur les différents produits de l'entreprise)</a> fut le EWI solo sortie en septembre 2020.</p>
    </p>
</div>
<br>
<caption>
...
<table class="table container">
    ...
    <tbody>
        <tr>
            ...
            <td class="text-center"><img src="Images/evi_1000.jpg" alt="EVI 1000"></td>
        </tr>
        <tr>
            <th class="table-dark text-center tableau">EWI 1000 (1987)</th>
            <td class="text-center"><img src="Images/ew_1000.jpg" alt="EWI 1000"></td>
        </tr>
        <tr>
            <th class="table-dark text-center tableau">EWI 4000S (2006)</th>
            <td class="text-center"><img src="Images/EWI_4000S.jpg" alt="EWI 4000S">
            <br>
            <!--lien vers un site externe-->
            <a href="https://www.akaipro.com/ewi4000s" target="_blank">Pour plus d'informations, cliquez-ICI</a></td>
        </tr>
        <tr>
            <th class="table-dark text-center tableau">EWI USB (2009)</th>
            <td class="text-center"><img src="Images/EWI_USB.jpg" alt="EWI USB">
            <br>
            <a href="https://www.akaipro.com/ewi-usb" target="_blank">Pour
                    plus d'informations, cliquez-ICI</a></td>
        </tr>
        <tr>
            <th class="table-dark text-center tableau">EWI5000 (2014)</th>
            <td class="text-center"><img src="Images/EWI5000.jpg" alt="EWI5000">
            <br>
        ...
        <tr>
            ...
            <td class="text-center"><img src="Images/EWI SOLO.jpg" alt="EWI SOLO">
            <br>
